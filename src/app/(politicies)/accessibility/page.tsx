  ...
  return (
    <div className="space-y-6">
      ...
      <section className="mt-6 space-y-4">
        ...
        <p>
          Hemos implementado filtros específicos para encontrar alojamientos que
          se adapten a tus necesidades de movilidad:
        </p>
      ...
      <section className="mt-6 space-y-4">
        ...
        <p>
          Trabajamos continuamente para que nuestra plataforma web y móvil
          cumpla con las pautas WCAG 2.1 AA, asegurando que sea navegable
          mediante lectores de pantalla y teclados.
        </p>
      </section>
    </div>
  );
