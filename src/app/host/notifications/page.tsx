...
export default function HostNotificationsPage() {
  ...
  const canAcceptOrDecline = activeNotification?.status === "PENDING" || false;
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="text-gray-dark-600">
              Revisa las solicitudes de reserva, toma decisiones y mantén
              informados a tus huéspedes.
            </p>
          </div>
            ...
            {!activeNotification ? (
              ...
              <div className="flex-1 space-y-6">
                  ...
                  <div className="rounded-2xl border border-rose-200 bg-rose-50 p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-gray-dark-700 space-y-1 text-sm">
                        ...
                        <p>
                          Verifica que la propiedad esté lista y coordina los
                          detalles de llegada. El check-in está programado para{" "}
                ...
                <div className="border-blue-light-100 rounded-2xl border bg-white/70 p-5">
                  ...
                  <div
                    className={`flex flex-col gap-6 ${canAcceptOrDecline ? "lg:flex-row" : ""}`}
                  >
                ...
                <div className="border-blue-light-100 text-gray-dark-600 rounded-2xl border bg-white/70 p-5 text-sm">
                  <p className="flex items-start gap-2">
                    ...
                    Mantén una comunicación clara. Los huéspedes recibirán un
                    correo con la decisión que tomes sobre su reserva.
                  </p>
                </div>
              </div>
            )}
