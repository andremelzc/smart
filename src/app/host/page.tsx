    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-600">
          Bienvenido de vuelta. Aqui tienes un resumen de tu actividad como anfitrion.
        </p>
      </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-yellow-600 mt-1">245 resenas</p>
            </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600">Maria Gonzalez - Apartamento Centro, 25-28 Oct</p>
            </div>
