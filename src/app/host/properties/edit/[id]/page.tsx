    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">ID de Propiedad Invalido</h1>
          <p className="text-gray-600 mb-6">El ID de la propiedad proporcionado no es valido.</p>
