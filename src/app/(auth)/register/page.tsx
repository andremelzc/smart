        ...
        <div className="bg-white rounded-3xl shadow-xl border border-blue-light-200 p-8 space-y-6">
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Nombre */}
              <div>
                <label htmlFor="firstName" className="block text-sm font-semibold text-gray-dark-700 mb-2">
                  Nombre
                </label>
                <div className="relative">
              ...
              {/* Apellido */}
              <div>
                <label htmlFor="lastName" className="block text-sm font-semibold text-gray-dark-700 mb-2">
                  Apellido
                </label>
                <div className="relative">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-medium-400" />
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-semibold text-gray-dark-700 mb-2">
                Confirmar contrasena
              </label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-medium-400" />
