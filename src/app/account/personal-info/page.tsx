...
export default function PersonalInfoPage() {
  ...
  if (!profileData.email) missingFields.push("Correo electronico");
  if (!profileData.phone) missingFields.push("Numero de telefono");
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-semibold text-amber-900 mb-1">
                Completa tu informacion personal para reservar
              </h3>
