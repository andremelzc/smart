    ...
    <div className="max-w-4xl space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-dark-600">
          Esta es la informacion que otros usuarios ven cuando visitan tu perfil. Ayuda a generar confianza y conectar con la comunidad.
        </p>
      </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              ...
              <div className="lg:w-80 flex-shrink-0">
                <div className="text-center">
                  ...
                  <p className="text-gray-dark-500 mb-4">Huesped</p>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-dark-500">Calificacion</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-800">
              Esta informacion es visible para otros usuarios de la plataforma. Ayuda a generar confianza y conectar con anfitriones y otros huespedes.
            </p>
          </div>
        </div>
      </div>
