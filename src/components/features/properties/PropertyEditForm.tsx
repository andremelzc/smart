      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-gradient-to-r from-blue-light-50 to-blue-light-100 p-6 rounded-lg border border-blue-light-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {renderInputField('title', 'Título de la Propiedad', 'text', 'Ej: Casa moderna con vista al mar')}
            {renderInputField('basePriceNight', 'Precio por Noche ($)', 'number', '100.00', <DollarSign size={16} />, '0.01', 0)}
          </div>

          <div className="mt-6">
            {renderInputField('descriptionLong', 'Descripción Completa', 'textarea', 'Describe tu propiedad en detalle...', undefined, undefined, undefined, 4)}
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-light-50 to-blue-light-100 p-6 rounded-lg border border-blue-light-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {renderInputField('addressText', 'Dirección', 'text', 'Ej: Calle Principal 123')}
            {renderInputField('city', 'Ciudad', 'text', 'Ej: Medellín')}
            {renderInputField('stateRegion', 'Estado/Región', 'text', 'Ej: Antioquia')}
            {renderInputField('country', 'País', 'text', 'Ej: Colombia')}
            {renderInputField('postalCode', 'Código Postal', 'text', 'Ej: 050001')}
          </div>
        ...
        <div className="bg-gradient-to-r from-blue-light-50 to-blue-light-100 p-6 rounded-lg border border-blue-light-200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            {renderInputField('bathrooms', 'Baños', 'number', '2', undefined, undefined, 1)}
          ...
          <div className="mt-6">
            {renderInputField('houseRules', 'Reglas de la Casa', 'textarea', 'Ej: No fumar, No mascotas, Hora de silencio después de las 10 PM...', undefined, undefined, undefined, 3)}
          </div>
        </div>
