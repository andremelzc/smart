  ...
  return (
    ...
    <div className="bg-white rounded-lg shadow-lg p-6 max-w-5xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-linear-to-r from-blue-light-50 to-blue-light-100 p-6 rounded-lg border border-blue-light-200">
        ...
        <div className="bg-lienar-to-r from-blue-light-50 to-blue-light-100 p-6 rounded-lg border border-blue-light-200">
