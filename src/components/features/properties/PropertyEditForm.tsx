        ...
        <div className="relative">
          ...
          {type === "textarea" ? (
            <textarea
              ...
              className={`w-full ${icon ? "pl-10" : "pl-3"} focus:ring-blue-light-500 rounded-lg border py-2 pr-3 transition-colors focus:ring-2 ${
                hasError
                  ? "border-red-300 focus:border-red-500"
                  : "focus:border-blue-light-500 border-gray-300"
              }`}
  ...
  return (
    <div className="mx-auto max-w-5xl rounded-lg bg-white p-6 shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="from-blue-light-50 to-blue-light-100 border-blue-light-200 rounded-lg border bg-linear-to-r p-6">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            {renderInputField(
              ...
              "text",
              "Ej: Casa moderna con vista al mar"
            )}
        ...
        <div className="bg-lienar-to-r from-blue-light-50 to-blue-light-100 border-blue-light-200 rounded-lg border p-6">
          <div className="mb-4 flex items-center gap-2">
            <Home className="text-blue-light-600" size={20} />
          ...
          <div className="mt-6">
            {renderInputField(
              ...
              "Reglas de la Casa",
              "textarea",
              "Ej: No fumar, No mascotas, Hora de silencio despues de las 10 PM...",
              undefined,
              undefined,
              undefined,
              3
