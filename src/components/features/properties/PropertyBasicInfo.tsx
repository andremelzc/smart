...
export function PropertyBasicInfo({
  ...
  return (
    <div className={className}>
      <div className="mb-4 flex flex-col justify-between gap-4 md:flex-row md:items-center">
        ...
        <div className="flex flex-shrink-0 items-center gap-3">
          <button
            ...
            className="flex items-center gap-1 text-sm text-gray-600 underline transition-colors hover:text-red-500"
          >
            <Heart
          ...
          <button
            onClick={handleShare}
            className="flex items-center gap-1 text-sm text-gray-600 underline transition-colors hover:text-gray-900"
          >
      ...
      <div className="mb-4 flex flex-col gap-2 text-gray-600 md:flex-row md:items-center md:gap-4">
