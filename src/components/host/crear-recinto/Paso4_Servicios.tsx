...
const amenityGroups = [
  ...
  },
  {
    ...
    amenities: [
      { id: '35.HEATING', name: 'Calefaccion' },
  ...
  },
  {
    ...
    amenities: [
      ...
      { id: '57.BABY_FRIENDLY', name: 'Apto para bebes' },
      { id: '42.CRIB', name: 'Cuna' },
      { id: '53.PETS_ALLOWED', name: 'Se permiten mascotas' },
    ]
  },
  {
    title: "Ubicacion y Entorno",
    amenities: [
  ...
  },
  {
    ...
    amenities: [
      ...
      { id: '52.CO_DETECTOR', name: 'Detector de monoxido' },
...
export function Paso4_Servicios({ data, updateData }: StepProps) {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <StepHeader
        title="Que servicios ofrece tu recinto?"
        subtitle="Selecciona todos los servicios que pones a disposicion de tus huespedes."
        helpText="Estos son los filtros mas usados por los huespedes. Asegurate de marcar solo lo que realmente ofreces para gestionar bien sus expectativas."
      />
