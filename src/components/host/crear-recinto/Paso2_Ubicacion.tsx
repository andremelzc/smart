...
export function Paso2_Ubicacion({ data, updateData }: StepProps) {
  ...
  // Simulacion de busqueda de direccion
  const handleSimulateSearch = () => {
    updateData({
      addressText: data.addressText || "Av. Jose Larco 123",
      city: "Miraflores",
      stateRegion: "Lima",
      country: "Peru",
      postalCode: "15074",
  ...
  return (
    <div className="flex flex-col gap-4">
      <StepHeader
        title="Donde esta ubicado tu recinto?"
        subtitle="Tu direccion solo se compartira con los huespedes despues de que confirmen una reserva."
        helpText="Puedes escribir tu direccion y presionar el boton de 'Buscar' o arrastrar el pin en el mapa para ajustar la ubicacion exacta. Los campos se rellenaran automaticamente."
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <label className="flex flex-col gap-2 text-sm font-semibold text-blue-light-700">
          Pais
          <input type="text" name="country" value={data.country} onChange={handleChange} placeholder="Ej: Peru" className="rounded-2xl font-medium border-2 border-blue-light-300 bg-blue-light-50 px-4 py-3 text-gray-dark-700 outline-none focus:border-blue-light-600 focus:ring-2 focus:ring-green-100" />
        </label>
