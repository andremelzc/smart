    ...
    async (lat: number, lng: number) => {
      ...
      try {
        ...
        if (data && data.address) {
          ...
          if (!streetAddress) {
            const roadType =
              address.highway || address.street || address.pedestrian;
            if (roadType) {
          ...
          if (!streetAddress) {
            ...
            if (
              /^(Av\.|Avenida|Jr\.|Jirón|Ca\.|Calle|Psje\.|Pasaje)/i.test(
                firstPart
              )
            ) {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (results && results.length > 0) {
        ...
        const result =
          results.find(
            (r: {
              ...
              return (
                addr.state?.toLowerCase().includes("lima") ||
        ...
        alert(
          'No se encontró la dirección. Intenta con: "Av. Larco, Miraflores" o solo el nombre del distrito.'
        );
      }
    } catch (error) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <label className="text-blue-light-700 flex flex-col gap-2 text-sm font-semibold md:col-span-2">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="border-blue-light-300 bg-blue-light-50 text-gray-dark-700 focus:border-blue-light-600 flex-grow rounded-2xl border-2 px-4 py-3 font-medium outline-none focus:ring-2 focus:ring-green-100"
            ...
            <button
              ...
              className="border-blue-light-600 bg-blue-vivid-600 hover:bg-blue-vivid-700 hover:border-blue-light-800 inline-flex flex-shrink-0 items-center justify-center rounded-2xl border-2 px-5 py-3 text-sm font-semibold text-white shadow-md transition-all disabled:cursor-not-allowed disabled:opacity-50"
            >
              {isGeocoding ? (
        ...
        <label className="text-blue-light-700 flex flex-col gap-2 text-sm font-semibold">
          Distrito
          <input
            type="text"
            name="city"
            ...
            className="border-blue-light-300 bg-blue-light-50 text-gray-dark-700 focus:border-blue-light-600 rounded-2xl border-2 px-4 py-3 font-medium outline-none focus:ring-2 focus:ring-green-100"
          />
        </label>
      ...
      <div className="mt-4">
        <p className="text-gray-dark-600 mb-2 text-lg font-medium">
          {isGeocoding
            ? "Buscando ubicación..."
        ...
        {!isClient ? (
          <div className="border-blue-light-300 bg-blue-light-50 flex h-96 w-full items-center justify-center rounded-2xl border-2">
            <Loader2 className="text-blue-light-600 h-8 w-8 animate-spin" />
          </div>
        ) : (
          <div className="border-blue-light-300 relative h-96 w-full overflow-hidden rounded-2xl border-2">
            <MapContainer
            ...
            {isGeocoding && (
              <div className="absolute inset-0 z-[1000] flex items-center justify-center bg-white/60 backdrop-blur-sm">
                <div className="flex items-center gap-3 rounded-xl bg-white px-6 py-4 shadow-lg">
                  <Loader2 className="text-blue-light-600 h-5 w-5 animate-spin" />
                  <span className="text-gray-dark-700 text-sm font-medium">
