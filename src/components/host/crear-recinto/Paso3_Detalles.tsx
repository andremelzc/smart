...
export function Paso3_Detalles({ data, updateData }: StepProps) {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <StepHeader
        title="Cuentanos mas sobre tu recinto"
        subtitle="Especifica los detalles basicos que los huespedes querran saber."
        helpText="Usa los botones '+' y '-' para ajustar las cantidades. Estos detalles son clave para los filtros de busqueda de los huespedes."
      />
      ...
      <div className="flex flex-col gap-2 ">
        ...
        <p className="text-md text-gray-dark-500">
          Define la capacidad y distribucion de tu recinto. (Minimo 1 huesped y 1 cama)
        </p>
        ...
        <div className="mt-4 rounded-2xl border border-blue-light-300 bg-blue-light-50 px-6">
          ...
          <DetailStepper
            ...
            label="Banos"
            description="Total de banos (enteros)"
