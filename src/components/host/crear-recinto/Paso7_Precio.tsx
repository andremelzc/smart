  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <StepHeader
        ...
        subtitle="Define cuanto quieres cobrar por tu espacio."
        helpText="El precio que definas aqui es la tarifa base. Los huespedes pagaran esto mas las comisiones de la plataforma. Puedes ajustarlo en cualquier momento."
      />
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center text-md">
                <span 
                    ...
                    >
                    Comision de servicio <span className="font-medium">({PLATFORM_FEE_PERCENT * 100}%)</span>
