  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <StepHeader
        ...
        helpText="Recuerde que ser claro con las reglas desde el principio ayuda a evitar malentendidos. Los huespedes deben aceptar estas reglas antes de reservar."
      />
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-md text-gray-dark-500">
          Anade cualquier otra norma especifica de tu espacio.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
          ...
          <div className="flex flex-col gap-2">
            <textarea
              ...
              onChange={handleChange}
              rows={8}
              placeholder="Ej: No hacer ruido despues de las 10 PM. No dejar la basura fuera..."
            ...
            >
              {data.houseRules.length} / {MIN_RULES_LENGTH} caracteres minimos recomendados
            </span>
          </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span className="text-gray-dark-700">
                  Invitados: Se permiten visitas que no esten en la reserva?
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 text-green-600 mt-1 flex-shrink-0" />
                  <span className="text-gray-dark-700">
                    Ruido: Hay horarios de silencio? (Ej: &quot;No musica alta despues de las 10 PM&quot;).
                  </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 text-green-600 mt-1 flex-shrink-0" />
