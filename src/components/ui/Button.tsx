...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseStyles =
      "inline-flex items-center justify-center font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed leading-none";

    const variants: Record<string, string> = {
      primary: `
      flex items-center justify-center text-white shadow-md   
      bg-gradient-to-br from-blue-vivid-500 to-blue-vivid-600 text-white
      hover:from-blue-vivid-600 hover:to-blue-vivid-700 hover:shadow-lg hover:scale-103 transition-all transform
      active:bg-blue-vivid-700
      focus:ring-blue-vivid-300
