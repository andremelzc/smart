        ...
        <div className="flex items-center justify-between py-5 lg:py-6">
          ...
          <div className="flex flex-shrink-0 items-center gap-3">
            ...
            <Link href="/" className="md:hidden">
              <button
                className="border-blue-light-200 hover:border-blue-light-300 group flex h-11 w-11 items-center justify-center rounded-full border bg-white shadow-sm transition-all hover:shadow-md"
                aria-label="Volver al inicio"
              >
                <ArrowLeft className="text-gray-dark-600 h-5 w-5 transition-transform group-hover:-translate-x-0.5" />
              </button>
            </Link>
