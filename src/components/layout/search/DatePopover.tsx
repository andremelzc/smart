      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 space-y-4">
          <div>
            ...
            <p className="text-xs text-gray-dark-500">Elige la fecha de llegada y salida para planificar tu estadía.</p>
          </div>
          ...
          <p className="text-xs text-gray-dark-400">
            Guardaremos estas fechas para que puedas usarlas cuando lances tu búsqueda.
          </p>
        </div>
      </div>
    </div>
